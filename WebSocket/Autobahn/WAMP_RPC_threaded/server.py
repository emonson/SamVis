...
class RpcServer1Protocol(WampServerProtocol):
   ...
   @exportRpc("add")
   def doAddInThread(self, x, y):
      """
      Trying to get long-running process to run in thread
      """
      print "Someone calling Long Add ***"
      return threads.deferToThread(self.doAdd, x, y)
   ...
   def doAdd(self, x, y):
      ...
      """
      time.sleep(2)
      print "getting ready to return from long add"
      return x + y
