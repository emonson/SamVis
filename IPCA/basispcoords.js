...
// "gene" data_type
// 
// right now, center and bases shown in images, but this is what should be replaced to
// create parallel coordinates plot of center and basis vectors
//
...
var NODE_BASIS_VIS = (function(d3, $, g){
	...
	// NOTE: Magic numbers which won't be needed when doing parallel coordinates
	var img_w_px = 7;
	var img_h_px = 3;
	// Screen dimensions
	var img_w = 56;
